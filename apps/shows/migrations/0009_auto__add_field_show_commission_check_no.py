...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Show.commission_check_no'
        db.add_column(u'shows_show', 'commission_check_no',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Show.commission_check_no'
        db.delete_column(u'shows_show', 'commission_check_no')
