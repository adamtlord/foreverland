...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Show.agent'
        db.add_column(u'shows_show', 'agent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='gig_agent', null=True, to=orm['fidouche.Agent']),
                      keep_default=False)

        # Adding field 'Show.commission_paid'
        db.add_column(u'shows_show', 'commission_paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Show.agent'
        db.delete_column(u'shows_show', 'agent_id')

        # Deleting field 'Show.commission_paid'
        db.delete_column(u'shows_show', 'commission_paid')
