...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payee.address'
        db.add_column(u'fidouche_payee', 'address',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Payee.city'
        db.add_column(u'fidouche_payee', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Payee.state'
        db.add_column(u'fidouche_payee', 'state',
                      self.gf('django.contrib.localflavor.us.models.USStateField')(max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Payee.zip_code'
        db.add_column(u'fidouche_payee', 'zip_code',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Payee.phone'
        db.add_column(u'fidouche_payee', 'phone',
                      self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Payee.ssn'
        db.add_column(u'fidouche_payee', 'ssn',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payee.address'
        db.delete_column(u'fidouche_payee', 'address')

        # Deleting field 'Payee.city'
        db.delete_column(u'fidouche_payee', 'city')

        # Deleting field 'Payee.state'
        db.delete_column(u'fidouche_payee', 'state')

        # Deleting field 'Payee.zip_code'
        db.delete_column(u'fidouche_payee', 'zip_code')

        # Deleting field 'Payee.phone'
        db.delete_column(u'fidouche_payee', 'phone')

        # Deleting field 'Payee.ssn'
        db.delete_column(u'fidouche_payee', 'ssn')
