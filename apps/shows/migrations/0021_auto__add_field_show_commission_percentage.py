...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Show.commission_percentage'
        db.add_column(u'shows_show', 'commission_percentage',
                      self.gf('django.db.models.fields.IntegerField')(default=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Show.commission_percentage'
        db.delete_column(u'shows_show', 'commission_percentage')
