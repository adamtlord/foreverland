...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductionPayment'
        db.create_table(u'fidouche_productionpayment', (
        ...
        db.send_create_signal(u'fidouche', ['ProductionCompany'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProductionPayment', fields ['show', 'company']
        db.delete_unique(u'fidouche_productionpayment', ['show_id', 'company_id'])

        # Deleting model 'ProductionPayment'
        db.delete_table(u'fidouche_productionpayment')

        # Deleting model 'ProductionCompany'
        db.delete_table(u'fidouche_productioncompany')
    ...
    models = {
        ...
        u'fidouche.productionpayment': {
            ...
            'amount': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'production_payment'", 'null': 'True', 'to': u"orm['fidouche.Agent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'paid': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
