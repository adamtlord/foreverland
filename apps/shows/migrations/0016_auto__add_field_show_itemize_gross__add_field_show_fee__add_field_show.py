...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Show.itemize_gross'
        db.add_column(u'shows_show', 'itemize_gross',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Show.fee'
        db.add_column(u'shows_show', 'fee',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Show.food_buyout'
        db.add_column(u'shows_show', 'food_buyout',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Show.travel_buyout'
        db.add_column(u'shows_show', 'travel_buyout',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Show.lodging_buyout'
        db.add_column(u'shows_show', 'lodging_buyout',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Show.other_buyout'
        db.add_column(u'shows_show', 'other_buyout',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Show.itemize_gross'
        db.delete_column(u'shows_show', 'itemize_gross')

        # Deleting field 'Show.fee'
        db.delete_column(u'shows_show', 'fee')

        # Deleting field 'Show.food_buyout'
        db.delete_column(u'shows_show', 'food_buyout')

        # Deleting field 'Show.travel_buyout'
        db.delete_column(u'shows_show', 'travel_buyout')

        # Deleting field 'Show.lodging_buyout'
        db.delete_column(u'shows_show', 'lodging_buyout')

        # Deleting field 'Show.other_buyout'
        db.delete_column(u'shows_show', 'other_buyout')
    ...
    models = {
        u'shows.show': {
            ...
            'itemize_gross': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
