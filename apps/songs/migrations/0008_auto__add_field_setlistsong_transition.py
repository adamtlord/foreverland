...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SetlistSong.transition'
        db.add_column(u'songs_setlistsong', 'transition',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SetlistSong.transition'
        db.delete_column(u'songs_setlistsong', 'transition')
    ...
    models = {
        ...
        u'songs.song': {
            ...
            'is_encore': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
