...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TourExpense'
        db.create_table(u'fidouche_tourexpense', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tour', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shows.Tour'], null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('payee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fidouche.Payee'], null=True, blank=True)),
            ('new_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fidouche.ExpenseCategory'], null=True, blank=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('check_no', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('receipt_img', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'fidouche', ['TourExpense'])


    def backwards(self, orm):
        # Deleting model 'TourExpense'
        db.delete_table(u'fidouche_tourexpense')
    ...
    models = {
        ...
        u'fidouche.tourexpense': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fidouche.ExpenseCategory']", 'null': 'True', 'blank': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
