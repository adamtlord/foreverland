...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Show.costs_itemized'
        db.add_column(u'shows_show', 'costs_itemized',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Show.costs_itemized'
        db.delete_column(u'shows_show', 'costs_itemized')
