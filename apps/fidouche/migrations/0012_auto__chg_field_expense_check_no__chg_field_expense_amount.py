...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'fidouche_expense', 'amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Expense.amount'
        db.alter_column(u'fidouche_expense', 'amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
