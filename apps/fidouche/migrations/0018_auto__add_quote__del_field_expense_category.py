...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Quote'
        db.create_table(u'fidouche_quote', (
            ...
            ('occasion', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ))
        db.send_create_signal(u'fidouche', ['Quote'])

        # Deleting field 'Expense.category'
        db.delete_column(u'fidouche_expense', 'category')


    def backwards(self, orm):
        # Deleting model 'Quote'
        db.delete_table(u'fidouche_quote')

        # Adding field 'Expense.category'
        db.add_column(u'fidouche_expense', 'category',
