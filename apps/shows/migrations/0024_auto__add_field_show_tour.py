...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Show.tour'
        db.add_column(u'shows_show', 'tour',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='show_in_tour', null=True, to=orm['shows.Tour']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Show.tour'
        db.delete_column(u'shows_show', 'tour_id')
