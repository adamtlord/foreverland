...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TourExpense.new_category'
        db.delete_column(u'fidouche_tourexpense', 'new_category_id')

        # Adding field 'TourExpense.category'
        db.add_column(u'fidouche_tourexpense', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fidouche.ExpenseCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TourExpense.new_category'
        db.add_column(u'fidouche_tourexpense', 'new_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fidouche.ExpenseCategory'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'TourExpense.category'
        db.delete_column(u'fidouche_tourexpense', 'category_id')
