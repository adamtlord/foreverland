...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Show.in_ears_cost'
        db.alter_column(u'shows_show', 'in_ears_cost', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Show.in_ears_cost'
        db.alter_column(u'shows_show', 'in_ears_cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
