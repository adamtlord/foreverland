...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Expense.date'
        db.add_column(u'shows_expense', 'date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Expense.show'
        db.alter_column(u'shows_expense', 'show_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['shows.Show']))

    def backwards(self, orm):
        # Deleting field 'Expense.date'
        db.delete_column(u'shows_expense', 'date')


        # User chose to not deal with backwards NULL issues for 'Expense.show'
        raise RuntimeError("Cannot reverse this migration. 'Expense.show' and its values cannot be restored.")
