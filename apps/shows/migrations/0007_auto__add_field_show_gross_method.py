...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Show.gross_method'
        db.add_column(u'shows_show', 'gross_method',
                      self.gf('django.db.models.fields.CharField')(default='cash', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Show.gross_method'
        db.delete_column(u'shows_show', 'gross_method')
    ...
    models = {
        ...
        u'shows.show': {
            ...
            'payee': ('django.db.models.fields.CharField', [], {'default': "'ABC'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
