...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Show.gross_itemized'
        db.add_column(u'shows_show', 'gross_itemized',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Show.gross_itemized'
        db.delete_column(u'shows_show', 'gross_itemized')
