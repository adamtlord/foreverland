...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Show.payer'
        db.add_column(u'shows_show', 'payer',
                      self.gf('django.db.models.fields.CharField')(default='client', max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'shows_show', 'payee',
                      self.gf('django.db.models.fields.CharField')(default='ABC', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Show.payer'
        db.delete_column(u'shows_show', 'payer')
