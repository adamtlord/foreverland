...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fidouche_commissionpayment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('show', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='commission_payment', null=True, to=orm['shows.Show'])),
            ('agent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='commission_payment', null=True, to=orm['fidouche.Agent'])),
            ('amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
            ('paid', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'fidouche', ['CommissionPayment'])

        # Adding unique constraint on 'CommissionPayment', fields ['show', 'agent']
        db.create_unique(u'fidouche_commissionpayment', ['show_id', 'agent_id'])

        # Adding model 'Agent'
        db.create_table(u'fidouche_agent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('agency', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ...
            ('ssn', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True)),
        ))
        db.send_create_signal(u'fidouche', ['Agent'])


    def backwards(self, orm):
        # Removing unique constraint on 'CommissionPayment', fields ['show', 'agent']
        db.delete_unique(u'fidouche_commissionpayment', ['show_id', 'agent_id'])

        # Deleting model 'CommissionPayment'
        db.delete_table(u'fidouche_commissionpayment')

        # Deleting model 'Agent'
        db.delete_table(u'fidouche_agent')
