...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'SetlistSong', fields ['setlist', 'order', 'song']
        db.create_unique(u'songs_setlistsong', ['setlist_id', 'order', 'song_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SetlistSong', fields ['setlist', 'order', 'song']
        db.delete_unique(u'songs_setlistsong', ['setlist_id', 'order', 'song_id'])
