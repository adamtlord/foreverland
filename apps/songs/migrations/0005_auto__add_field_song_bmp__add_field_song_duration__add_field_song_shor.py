...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'songs_song', 'duration',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Song.short_name'
        db.add_column(u'songs_song', 'short_name',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Song.is_break'
        db.add_column(u'songs_song', 'is_break',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'songs_song', 'duration')

        # Deleting field 'Song.short_name'
        db.delete_column(u'songs_song', 'short_name')

        # Deleting field 'Song.is_break'
        db.delete_column(u'songs_song', 'is_break')
    ...
    models = {
        ...
        u'songs.song': {
            ...
            'bmp': ('django.db.models.fields.IntegerField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
