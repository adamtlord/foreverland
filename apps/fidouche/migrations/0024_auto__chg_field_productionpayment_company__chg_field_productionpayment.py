...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductionPayment.company'
        db.alter_column(u'fidouche_productionpayment', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['fidouche.ProductionCompany']))

        # Changing field 'ProductionPayment.amount'
        db.alter_column(u'fidouche_productionpayment', 'amount', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=10, decimal_places=2))

        # Changing field 'Expense.receipt_img'
        db.alter_column(u'fidouche_expense', 'receipt_img', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'ProductionPayment.company'
        db.alter_column(u'fidouche_productionpayment', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['fidouche.ProductionCompany']))

        # Changing field 'ProductionPayment.amount'
        db.alter_column(u'fidouche_productionpayment', 'amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
        # Adding unique constraint on 'ProductionPayment', fields ['company', 'show']
        db.create_unique(u'fidouche_productionpayment', ['company_id', 'show_id'])


        # Changing field 'Expense.receipt_img'
        db.alter_column(u'fidouche_expense', 'receipt_img', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))
